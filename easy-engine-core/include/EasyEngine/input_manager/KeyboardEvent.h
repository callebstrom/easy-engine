...
#define 	EE_KEY_WORLD_1   161
#define 	EE_KEY_WORLD_2   162
...
#define 	EE_KEY_LAST   EE_KEY_MENU

#define EE_MOD_SHIFT           0x0001
#define EE_MOD_CONTROL         0x0002
#define EE_MOD_ALT             0x0004
#define EE_MOD_SUPER           0x0008

#define EE_KEY_ACTION_PRESSED 0
#define EE_KEY_ACTION_RELEASED 1
#define EE_KEY_ACTION_REPEATED 2
...
namespace easy_engine {
	namespace input_manager {
		struct KeyboardEvent {
			...
			KeyboardEvent(int key, int modifiers, int action)
