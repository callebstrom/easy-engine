...
namespace easy_engine {
	...
	namespace render_manager {
		...
		public:
			...
			virtual void Render(resource::PointLight point_light, Eigen::Vector3f translation) = 0;
			virtual void Render(resource::DirectionalLight directional_light, Eigen::Vector3f translation) = 0;
